...
//   // [об'єкт Moore Hensley, об'єкт Sharlene Bush, 
//   //об'єкт Carey Barr]
...
// [об'єкт Moore Hensley, об'єкт Ross Vazquez, 
...
// [об'єкт Moore Hensley, об'єкт Sharlene Bush,
// об'єкт Blackburn Dotson, об'єкт Sheree Anthony]
...
const getNamesSortedByFriendsCount = users => {
 return users.sort((prevUser, nextUser)=>{
  return prevUser.friends.lenght - nextUser.friends.lenght
 }).map((user)=>{
  return user.name
 })
};
...
user.skills.forEach(skill=> {
  if(totalSkills.includes(skill)){return}
